# sovariel_primes.py
# Sovariel v5.5 — Prime-Perfect Fractal Lattice
# © 2025 EvieSovariel | github.com/EvieSovariel/Sovariel
# License: MIT
# Verified:
#   sum_primes_below(1_000_000) → 37,550,402,023
...
if __name__ == "__main__":
    ...
    # Verify known sums
    print("Sum of primes < 1,000,000:", 
          sum_primes_below(1_000_000, depth=16, threshold=0.5, use_filter=True))
    # → 37550402023

    print("Sum of primes < 1,000,000,000,000:", 
          sum_primes_below(1_000_000_000_000, depth=30, threshold=0.5, use_filter=True))
